...
public class ExamenJuegoAhorcado{
   public static void main(String args[])
   {
      ...
      for(int i=1;i<letras.length;i++){
         intento[i]="_ ";//Asignando lineas de la palabra ingresada asi la variable intento
                                            }
        ...
        for(int i=1;i<letras.length;i++)
           {
            ...
            {  //si la pabra no fue ingresada antes entrara
             ...
             if(aviso==false){System.out.println(" Aviso: Ya ingresaste esa letra ");}
             aviso=true;        
             if(VD==true)
             { //reduciendo intentos
               intentos--;
