...
public class TareaArreglos {
    ...
    public static void main(String[] args) {
        TareaArreglos tareas = new TareaArreglos();
        tareas.menu();
    }
    ...
    public void menu() {
        do {
            ...
            System.out.println("1.- Tarea 1: Suma de numeros enteros positivos y negativos y obtener el promedio");
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    break;
                default:
                    System.out.println("Opción no válida, te has salido del programa.");
                    System.exit(0);
            }
